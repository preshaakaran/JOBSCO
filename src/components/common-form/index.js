...
function CommonForm({ action,buttonText,isBtnDisabled,formControls,btnType,formData,setFormData,handleFileChange }) {
  ...
  return (
    <form action={action}>
        ...
        <div claassName="mt-6 w-full">
            <Button disabled={isBtnDisabled} type={btnType || "submit"} className="disabled:opacity-60 flex h-11 items-center justify-center px-5">{buttonText}</Button>
